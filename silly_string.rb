...
your_favorite_word = "celestial"

puts "My favorite word is #{your_favorite_word}"

# Challenge 2: Capitalize every letter in your_favorite_word using a built in Ruby method

favorite_word_in_all_caps = "celestial".upcase # Put a . after your_favorite word and use a String method.
...
sentence = "Astounding aardvarks, arguably an ancient animal, always ate apples and acorns and artichokes all around Athens, amazing!".gsub(/[ao]/,'a'=>'o', 'o'=>'a')
